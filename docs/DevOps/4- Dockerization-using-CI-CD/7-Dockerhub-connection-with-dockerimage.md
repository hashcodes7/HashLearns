...
![Account Settings](Pasted%20image%2020260815134443.png)

2. Click on **New Access Token**.
![New Token](Pasted%20image%2020260815134543.png)

3. Give it a descriptive name (like `github-actions-push`) and create it.
![Create Token](Pasted%20image%2020260815134615.png)

This will generate a secure Docker repository token that looks something like this:
![Generated Token](Pasted%20image%2020260815155751.png)
...
![GitHub Settings](Pasted%20image%2020260815134954.png)

2. Click on **New repository secret**.
![New Secret Button](Pasted%20image%2020260815135247.png)

3. Create the following two secrets identically as shown:
![Create Secret Name](Pasted%20image%2020260815135340.png)
![Create Secret Value](Pasted%20image%2020260815135429.png)
...
![Pipeline Success](Pasted%20image%2020260815135902.png)