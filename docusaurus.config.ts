...
import remarkComicStrip from './plugins/remark-comic-carousel';
...
const config: Config = {
  ...
  url: 'https://hashlearns.pages.dev',
    ...
    [
      'classic',
      {
        docs: {
          ...
          beforeDefaultRemarkPlugins: [obsidianImages, remarkStyleStringToJsx, remarkComicStrip],
